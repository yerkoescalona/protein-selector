"""Tests for protein_selector.structural_biology.models.
...
def test_models_module_never_imports_rcsbapi():
    ...
    # run may have already imported protein_selector.structural_biology.candidates
    ...
    result = subprocess.run(
        [
            sys.executable,
            "-c",
            "import sys; import protein_selector.structural_biology.models; "
...
def test_candidates_reexports_are_identical_objects():
    from protein_selector.structural_biology import candidates, models
...
def test_composition_reexports_are_identical_objects():
    from protein_selector.structural_biology import composition, models
